...
{    
    ...
    {    
        $newBackupFileName = "$($fileObject.BaseName)_Backup$ $($fileObject.Extension)"
        #Backup the file since text was found
        Copy-item -Path $folder\$fileObject -Destination $folder\$newBackupFileName
